...
<%
	...
	<div class="container">
							...
							<div class="input-box">
							<span class="department" for="department">Department</span> <input
								type="text" placeholder="Enter Department" name="department"
								value="${department}" id="department" required>
						</div>
							
	<%
		if (request.getAttribute("id") == null || request.getAttribute("id") == "") {
			out.print("<span class='details' for='department'>Department</span>" +
				    "<input type='text' placeholder='Enter department' name='department' id='department' value=" +
	...
	%>
						<div class="input-box">
							<span class="details" for="details">Department Details</span> <input
								type="text" placeholder="Department details" name="details"
